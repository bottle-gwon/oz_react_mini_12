export default function DetailCard({movieDetail}) {
    ...
    return(
        ...
        <div className="flex flex-col md:flex-wrap justify-center items-center md:px-[10px] lg:flex-row">
          ...
          <div className="flex flex-col  justify-around border boder-solid rounded-[10px] px-[10px] sm:h-3/4  md:flex-4">
            <div className="flex justify-around px-[10px] flex-1 border-b">
              <p className="text-2xl sm:text-6xl">{movieDetail.title}</p>
              <p className=" sm:text-4xl">⭐️: {movieDetail.vote_average? movieDetail.vote_average.toFixed(1): ""}</p>
            </div>
